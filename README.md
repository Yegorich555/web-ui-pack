...
- [**dateFromString**(v:string, format="yyyy-MM-dd hh:mm:ss AZ", {strict: true})](src/helpers/dateFromString.ts) ⇒ `Returns parsed date from string based on pointed format`
