...
describe("circleElement", () => {
  ...
  test("render single item", async () => {
    ...
    await nextFrame();
    expect(el.innerHTML).toMatchInlineSnapshot(
      `"<svg viewBox="0 0 100 100" role="img" aria-label="3%"><path d="M0 50 A50 50 0 1 0 100 50 A50 50 0 1 0 0 50 M14 50 A36 36 0 1 0 86 50 A36 36 0 1 0 14 50 Z"></path><g><path d="M 50 3.1415926535897967 A 3.141592653589793 3.141592653589793 0 0 1 53.13952597646568 0.09866357858642516 A 50 50 0 0 1 55.573446610316275 0.31160404197018465 A 3.141592653589793 3.141592653589793 0 0 1 58.13687704407884 3.853477151451024 L 56.79686623527718 11.453056089499086 A 3.141592653589793 3.141592653589793 0 0 1 53.13760673891569 14.136990868697161 A 36 36 0 0 0 53.13760673891569 14.136990868697161 A 3.141592653589793 3.141592653589793 0 0 1 50 10.858407346410203 Z"></path></g></svg><strong>3%</strong>"`
    );
