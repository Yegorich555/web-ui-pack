...
describe("formElement", () => {
  ...
  test("$initModel / $model", () => {
    ...
    expect(el.outerHTML).toMatchInlineSnapshot(
      `"<wup-form role="form"><wup-text><label for="txt1"><span><input placeholder=" " type="text" id="txt1" autocomplete="off"><strong>Email</strong></span><button clear="" tabindex="-1" aria-hidden="true" type="button" style=""></button></label></wup-text><wup-text><label for="txt2"><span><input placeholder=" " type="text" id="txt2" autocomplete="off"><strong>First Name</strong></span><button clear="" tabindex="-1" aria-hidden="true" type="button" style=""></button></label></wup-text><wup-text><label for="txt3"><span><input placeholder=" " type="text" id="txt3" autocomplete="off"><strong></strong></span><button clear="" tabindex="-1" aria-hidden="true" type="button" style=""></button></label></wup-text><button type="submit"></button></wup-form>"`
    );
  ...
  describe("submit", () => {
    ...
    test("pending on submit", async () => {
      ...
      await h.wait();
      expect(el.outerHTML).toMatchInlineSnapshot(
        `"<wup-form role="form" disabled=""><wup-text><label for="txt1"><span><input placeholder=" " type="text" id="txt1" autocomplete="off" disabled=""><strong>Email</strong></span><button clear="" tabindex="-1" aria-hidden="true" type="button" style="display: none;"></button></label></wup-text><wup-text><label for="txt2"><span><input placeholder=" " type="text" id="txt2" autocomplete="off" disabled=""><strong>First Name</strong></span><button clear="" tabindex="-1" aria-hidden="true" type="button" style="display: none;"></button></label></wup-text><wup-text><label for="txt3"><span><input placeholder=" " type="text" id="txt3" autocomplete="off" disabled=""><strong></strong></span><button clear="" tabindex="-1" aria-hidden="true" type="button" style="display: none;"></button></label></wup-text><button type="submit" disabled="" aria-busy="true"></button><wup-spin style="position: absolute; display: none;" aria-label="Loading. Please wait"><div></div></wup-spin></wup-form>"`
      );
      ...
      await h.wait();
      expect(el.outerHTML).toMatchInlineSnapshot(
        `"<wup-form role="form"><wup-text><label for="txt1"><span><input placeholder=" " type="text" id="txt1" autocomplete="off"><strong>Email</strong></span><button clear="" tabindex="-1" aria-hidden="true" type="button" style="display: none;"></button></label></wup-text><wup-text><label for="txt2"><span><input placeholder=" " type="text" id="txt2" autocomplete="off"><strong>First Name</strong></span><button clear="" tabindex="-1" aria-hidden="true" type="button" style="display: none;"></button></label></wup-text><wup-text><label for="txt3"><span><input placeholder=" " type="text" id="txt3" autocomplete="off"><strong></strong></span><button clear="" tabindex="-1" aria-hidden="true" type="button" style="display: none;"></button></label></wup-text><button type="submit"></button></wup-form>"`
      );
      ...
      expect(el.outerHTML).toMatchInlineSnapshot(
        `"<wup-form role="form"><wup-text><label for="txt1"><span><input placeholder=" " type="text" id="txt1" autocomplete="off"><strong>Email</strong></span><button clear="" tabindex="-1" aria-hidden="true" type="button" style="display: none;"></button></label></wup-text><wup-text><label for="txt2"><span><input placeholder=" " type="text" id="txt2" autocomplete="off"><strong>First Name</strong></span><button clear="" tabindex="-1" aria-hidden="true" type="button" style="display: none;"></button></label></wup-text><wup-text><label for="txt3"><span><input placeholder=" " type="text" id="txt3" autocomplete="off"><strong></strong></span><button clear="" tabindex="-1" aria-hidden="true" type="button" style="display: none;"></button></label></wup-text><button type="submit" disabled=""></button><wup-spin style="display: none;"><div></div></wup-spin></wup-form>"`
      );
      await h.wait();
      await h.wait(1);
