...
describe("formElement", () => {
  test("ordinary submit behavior", async () => {
    ...
    expect(t.html).toMatchInlineSnapshot(`
      "<wup-form role=\\"form\\">
              <wup-text name=\\"firstName\\" id=\\"inp1\\"><label for=\\"wup1\\"><span><input placeholder=\\" \\" type=\\"text\\" id=\\"wup1\\" autocomplete=\\"off\\"><strong>First Name</strong></span><button clear=\\"\\" aria-hidden=\\"true\\" tabindex=\\"-1\\"></button></label></wup-text>
              <wup-text name=\\"lastName\\" id=\\"inp2\\"><label for=\\"wup2\\"><span><input placeholder=\\" \\" type=\\"text\\" id=\\"wup2\\" autocomplete=\\"off\\"><strong>Last Name</strong></span><button clear=\\"\\" aria-hidden=\\"true\\" tabindex=\\"-1\\"></button></label></wup-text>
              <button type=\\"submit\\">Submit</button>
            </wup-form>"
    `);
  });
