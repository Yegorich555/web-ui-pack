  ...
  test("scrollIntoView to invalid input", async () => {
    ...
    expect(t.html).toMatchInlineSnapshot(`
      "<wup-form role="form">
              ...
              <wup-text name="lastName" id="inp2"><label for="wup4"><span><input placeholder=" " type="text" id="wup4" autocomplete="off" aria-required="true"><strong>Last Name</strong></span><button clear="" tabindex="-1" aria-hidden="true" type="button"></button></label></wup-text>
              <button type="submit">Submit</button>
            </wup-form>"
    `);
    ...
    expect(t.html).toMatchInlineSnapshot(`
      "<wup-form role="form">
              <wup-text name="firstName" id="inp1"><label for="wup3"><span><input placeholder=" " type="text" id="wup3" autocomplete="off" aria-required="true"><strong>First Name</strong></span><button clear="" tabindex="-1" aria-hidden="true" type="button"></button></label></wup-text>
